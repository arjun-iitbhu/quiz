...
<?php include("includes/check_cookie.php") ;?>
    ...
    if (isset($_POST['submit_user'])) {
        ...
        if (mysqli_fetch_row($result)) {
            ...
            if (isset($_POST['remember_me'])){
                ...
                setcookie("remember_me", $token, time()+60*60*24*365, '/');
                $q = "UPDATE users SET token = '$token' WHERE (Email = '$user_name');";
    ...
    <div id="full">
        ...
        <form action="index.php" method="post">
            ...
            <input type="checkbox" name="remember_me"  onclick="checkbox()" id="cb" /><span id="remember_me">Keep me logged in</span>
    ...
    if (isset($_POST['submit_new_user'])) {
        ...
        if(has_presence($firstname) && has_presence($newemail) && has_presence($newpassword) && correct_email_format($newemail) && $_POST['newconfirmpassword']===$_POST['newpassword']){
            ...
            $_SESSION["id"] = $id = pass_encrypt($_POST['newemail'].$_POST['newpassword']);
    ...
    <div id="full">
        ...
        <form action="index.php" method="post">
            ...
            <span class="label">Password: <span class="warning"><?php echo $error_password?></span><input type="password" name="newpassword" value="" id="p" onkeyup="password_match()"/><br/></span>
            <span class="label">Confirm Password: <input type="password" name="newconfirmpassword" value="" id="c_p" onkeyup="password_match()"/><br/></span>
            <br/><span class="label" id="p_match"></span></br>
